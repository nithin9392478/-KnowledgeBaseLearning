...
const SearchBox = () => {
  return (
    <div className="search-image d-flex justify-content-center align-items-center flex-column">
        <div className="d-flex align-items-center justify-content-center text-light  artical-search">Search all KB articals</div>
            <div className="w-75 px-3">
                <div className="search-input-container">
                    <i className="bi bi-search search-icon search-icon-symbol"></i>
